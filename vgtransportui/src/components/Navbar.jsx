  ...
  return (
    ...
    <div className="px-3 flex items-center justify-between w-full h-full">
      <div className="flex items-center">
        <h1 className="text-4xl font-bold">Vg Transport</h1>
      </div>
      ...
      <ul className="hidden md:flex">
        {links.map(({ id, link }) => (
          <li
            key={id}
            className="capitalize p-4 cursor-pointer hover:text-black duration-200"
          >
      ...
      <div className="hidden md:flex mr-4">
        <BlackButton title="sign in" className="px-9 py-3" />
      </div>
    ...
    >
      ...
      >
        ...
        <div className="mt-24 flex flex-col h-fit gap-12">
          <BlackButton className="px-9 py-3 capitalize" title="sign in" />
